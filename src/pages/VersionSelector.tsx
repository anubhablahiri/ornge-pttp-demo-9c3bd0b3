  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 py-12 relative">
      ...
      <button
        ...
        className="mt-10 flex items-center gap-2 px-6 py-3 rounded-xl border-2 border-secondary bg-secondary text-primary font-medium transition-all hover:opacity-90"
      >
