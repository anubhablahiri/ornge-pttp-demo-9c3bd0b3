...
export default function V2AdminLogin() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setLoading(true);
    setTimeout(() => navigate('/v2/admin'), 800);
  };
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-background px-4">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-center text-foreground">Operations Administration (v2)</h1>
        ...
        <div className="bg-card rounded-2xl shadow-lg p-6 border border-border">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <Label htmlFor="v2-admin-email" className="text-sm font-medium">Email Address</Label>
              <Input id="v2-admin-email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="h-12 rounded-lg" />
            </div>
            <div className="space-y-1.5">
              <Label htmlFor="v2-admin-pass" className="text-sm font-medium">Password</Label>
              <div className="relative">
                <Input id="v2-admin-pass" type="password" value={password} onChange={(e) => setPassword(e.target.value)} className="h-12 rounded-lg pr-10" />
