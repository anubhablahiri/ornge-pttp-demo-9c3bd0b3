...
export default function V1FormatSelector() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="mx-4 md:mx-auto md:max-w-3xl flex-1">
        ...
        <button onClick={() => navigate('/v1')} className="flex items-center justify-center gap-1.5 mt-6 text-sm text-muted-foreground hover:text-foreground transition-colors w-full">
